...
if ( ! class_exists( 'CSF_Field_media' ) ) {
  class CSF_Field_media extends CSF_Fields {
    ...
    public function render() {
      ...
      echo '<a href="#" class="button button-primary csf--button" data-library="'. esc_attr( $library ) .'" data-preview-size="'. esc_attr( $args['preview_size'] ) .'"><img src="'.MBWP_HP_URL.'/assets/images/admin/upload-image.svg" alt="upload">'. $args['button_title'] .'</a>';
