        ...
        public function add_options_html()
        {
            ...
            <div class="csf-container">
                <form method="post" action="" enctype="multipart/form-data" id="csf-form" autocomplete="off" novalidate="novalidate">
                    <input type="hidden" class="csf-section-id" name="csf_transient[section]" value="1">
                    <?php wp_nonce_field('csf_options_nonce', 'csf_options_nonce' . $this->unique); ?>
                    <div class="csf-container-inner">
                        <div class="csf-main-content">

                            <div class="csf-header  <?php echo esc_attr($sticky_class); ?>">
                                <div class="csf-header-inner">
                                    ...
                                    ?>
                                    <h1><strong><?php echo $this->args['framework_title']; ?></strong></h1>
                                    <h1 id="csf-breadcrumbs"></h1>
                                </div>
                                ...
                                <div class="csf-sections">
                                    ...
                                    <div class="csf_btn-submit">
                                        <button type="submit" name="_prefix_my_options[_nonce][save]" class="button button-primary csf-top-save csf-save csf-save-ajax" data-save="Đang lưu...">
                                            <img src="<?php echo MBWP_HP_URL ?>assets/images/admin/Luu.svg" alt="save">
                                            <?php echo __('Lưu', 'mbwp-helper'); ?>
                                        </button>
                                        <div class="csf-form-result csf-form-success csf-form-show" style="display: none;">Settings saved.</div>
                                    </div>
                                </div>
                        ...
                        <div class="csf-sidebar">

                            <div class="csf-sidebar-header">
                                <div class="csf-sidebar-img">
                                    <img src="<?php echo MBWP_HP_URL ?>assets/images/admin/WordPressHelperPlugin.svg" alt="WordPressHelperPlugin">
                                </div>
                                <div class="csf-sidebar-title">
                                    <h1><strong>WordPress Helper Lite</strong></h1>
                                </div>
                            </div>

                            <div class="csf-sidebar-text">
                                <ul>
                                    <li>Được phát triển bởi công ty <strong>Mắt Bão</strong></li>
                                    <li>Tự hào <strong>sản phẩm của người Việt</strong></li>
                                </ul>
                            </div>

                            <div class="csf-sidebar-banner csf-mt-30">
                                <a href="https://www.matbao.net/hosting/cloud-wordpress-hosting.html">
                                    <img src="<?php echo MBWP_HP_URL ?>assets/images/admin/Banner-WordPress-V4.gif" alt="Banner WP V3">
                                </a>
                            </div>

                            <div class="csf-sidebar-rating csf-mt-30">
                                <div class="csf-rating-star-text">
                                    <p>Chia sẻ <strong>trải nghiệm</strong> của bạn với <strong>sản phẩm</strong> của chúng tôi <strong>để góp phần cải thiện sản phẩm</strong> tốt hơn.</p>
                                </div>
                                <div class="csf-rating-star">
                                    <a href="https://wordpress.org/plugins/wp-helper-lite/#reviews" target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="36px" height="35px" viewBox="0 0 36 35" version="1.1">
                                            ...
                                            <g id="Page-1" stroke="none" stroke-width="1" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                                                <g id="WPHelper_Header&amp;Footer" transform="translate(-1285.000000, -889.000000)" stroke="#C7C6C4">
                                                    <g id="Group-3" transform="translate(1228.000000, 778.000000)">
                                                        <polygon id="Stroke-1" points="75 111 69.747 122.192182 58 123.986455 66.5 132.699727 64.494 145 75 139.192182 85.506 145 83.5 132.699727 92 123.986455 80.253 122.192182" />
                                                    </g>
                                                </g>
                                            </g>
                                        </svg>
